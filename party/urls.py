...
gift_registry_urlpatterns: list[URLPattern] = [
    path(route="party/<uuid:party_uuid>/gifts/", view=views.GiftRegistryPage.as_view(), name="page_gift_registry"),
    path(route="gifts/<uuid:gift_uuid>/", view=views.GiftDetailPartial.as_view(), name="partial_gift_detail"),
    path(route="gifts/<uuid:gift_uuid>/form/", view=views.GiftUpdateFormPartial.as_view(), name="partial_gift_update"),
]
